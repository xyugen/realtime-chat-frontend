...
const Input = (
  { id, type, value = '', className, placeholder, onChange, required }:
  { id?: string, type?: string, value?: string, className?: string, placeholder?: string, onChange?: any, required?: boolean }
) => {
  return (
    <input
      id={id}
